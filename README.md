...
**0단계 — 환경 조성.** 규칙·검사·자동화를 세워, 세션이 **관제탑 없이도 같은 규칙으로 굴러가게** 합니다. 지금 하고 있는 것이고, 마일스톤 `P0`·`P1`·`P2` 가 **전부 이 단계 안**에 삽니다.
...
다만 **마일스톤이 세는 것은 0단계뿐**입니다. 1·2단계의 진척을 세는 자리는 **아직 없고**, 위의 쪼개기가 1단계의 자리를 만듭니다 — 그전까지는 **없는 것을 없다고 적어 둡니다.**
